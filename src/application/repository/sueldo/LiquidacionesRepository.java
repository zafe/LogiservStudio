    ...
    public static ObservableList<Liquidaciones> buscarLiquidaciones(){
        ...
        try {
            ...
            while(resultSet.next()){
                ...
                liquidacion.setFechaLiquidacion(resultSet.getString("fecha"));
    ...
    public ObservableList<LiquidacionEmpleado> getEmpleadosLiquidadosByidLiquidacion(int idLIQUIDACION){
        ...
        try {
            ...
            preparedStatement=connection.prepareStatement("SELECT EMPLEADO.idEmpleado, EMPLEADO.Apellido, EMPLEADO.Nombre," +
                    ...
                    "                    WHERE\n" +
                    "                    LIQUIDACION_EMPLEADO.idLiquidacionEmpleado = ?;");
...
//                empleadosLiquidados.setEmpleado(empleado.idEmpleadoProperty()==resultSet.getInt(1));
...
//                  empleadosLiquidados.setEmpleado(empleado.apellidoProperty());
//                empleadosLiquidados.setEmpleado(empleado.setNombre(resultSet.getString(3)));
//                empleadosLiquidados.setEmpleado(empleado.setCategoria(resultSet.getString(4)));
