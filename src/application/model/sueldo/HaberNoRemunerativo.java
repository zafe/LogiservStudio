...
public class HaberNoRemunerativo extends ConceptoCalculado implements Calculeable {
    @Override
    ...
    public HaberNoRemunerativo(double numero, ConceptoSueldo conceptoSueldo) {
